    ...
    <div class="body_wrapper">
        ...
        <section class="check_demo_movie">
            <div class="container" style="max-width: 1300px;">
                <div class="row">
                    <div class="col-md-4">
                         <img style="width: 100px; border-radius: 50px;" src="{{asset('images/1.jpg')}}" alt="">
                         <div class="card">
                         ...
                         <div class="card">
                            <div class="card-header">
                               <a href="/album">All Albums ({{auth()->user()->albums->count()}})</a>
                            </div>
                         </div>
                         <div class="card">
                             <div class="card-header">
                                <a href="/publicalbum">Public Albums ({{auth()->user()->publicalbums->count()}})</a>
                             </div>
                         </div>
                         <div class="card">
                             <div class="card-header">
                                <a href="/privatealbum">Private Albums ({{auth()->user()->privatealbums->count()}})</a>
                             </div>
                         </div>
                         <div class="card">
                            <div class="card-header">
